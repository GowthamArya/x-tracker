...
export class GmailService {
  ...
  connections(id: number): Observable<{ added: number; autoAdded: number; pending: number }> { return this.http.post<{ added: number; autoAdded: number; pending: number }>(`${this.apiUrl}/connections/${id}/sync`, {}); }
